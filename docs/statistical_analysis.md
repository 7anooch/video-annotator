...
This document provides comprehensive documentation for the statistical analysis methods available in the enhanced analysis tools. The enhanced analysis tools now include graphical visualizations for change point detection and segment transition matrices, making it easier to understand the patterns in your annotation data.

## Running the Enhanced Analysis Tools

### Standalone Scripts

The enhanced analysis tools can be run as standalone scripts:
...
You can now also run the enhanced analysis tools directly through the existing analysis tools using the `--advanced` option:
...
You can also run the enhanced analysis tools through the main.py interface:
...
The advanced analyses now include:

- **Change Point Detection with Visualization**: Detects significant changes in the annotation patterns and displays a graphical visualization in your web browser. This helps you identify where important transitions occur in your data.

- **Segment Transition Matrix with Visualization**: Generates a transition matrix for grouped segments and displays a graphical visualization in your web browser. This helps you understand how different annotation labels transition between each other.

- **Hidden Markov Model Analysis**: Models the annotation data as a hidden Markov model to identify underlying states and transitions (requires hmmlearn package).

- **Anomaly Detection**: Detects anomalies in the annotation data using Z-score and IQR methods to identify unusual patterns.
...
For more information on running the enhanced analysis tools, see the [Analysis Tools README](analysis_tools/README.md).
...
The `detect_change_points` method detects change points in annotation data using advanced statistical methods and now includes a graphical visualization of the results.
...
- `segments`: List of segments, where each segment is a dictionary with the following keys:
...
- `visualization`: Base64-encoded image of the visualization (new feature)
